...
| 005 | Test-suite hygiene (dead test, vacuous assert, dangling ref, brittle metadata) | P2 | S | — | TODO |
...
| 016 | CI/build hygiene: pre-commit cache, dockerignore `.agents/`, `$$POSTGRES_USER` fix | P3 | S | — | TODO |
